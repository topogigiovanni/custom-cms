...
l(2)
const modelResolver = require('../model/modelResolver');
l(233)
...
app.use('/api', function replaceableRouter (req, res, next) {
  debugger;
  global.routes(req, res, next)
});
app.use('/static', express.static(staticPath));

l(3)
modelResolver.init(routes, app);
l(4);
